...
평가계 공통 설정, 학사일정, 담당 교사 계정과 학년 배정, Template 기반 교사 입력, 자동 검증, 제출·수정 요청·승인, 승인된 현재 학기 전 과목 취합과 인쇄/PDF 저장을 하나의 흐름으로 제공한다. 운영 환경은 인증을 강제하며 계정이 없는 로컬 개발 환경에서만 체험 모드를 사용할 수 있다.
