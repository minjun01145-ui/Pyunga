...
describe("normalizeEvaluationTemplateSections", () => {
  it("assigns order and parent ids across all seven document heading levels", () => {
    ...
    expect(sections).toEqual([
      { id: "l1", title: "평가 세부계획", level: 1, order: 0 },
      { id: "l2", title: "평가의 목적", level: 2, order: 1, parentId: "l1" },
      { id: "l3", title: "평가 방침", level: 3, order: 2, parentId: "l2" },
      { id: "l4", title: "세부 기준", level: 4, order: 3, parentId: "l3" },
      { id: "l5", title: "적용 대상", level: 5, order: 4, parentId: "l4" },
      { id: "l6", title: "지필평가", level: 6, order: 5, parentId: "l5" },
      { id: "l7", title: "중간고사", level: 7, order: 6, parentId: "l6" },
    ]);
  });
